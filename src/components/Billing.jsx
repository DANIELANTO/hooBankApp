  ...
  return (
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        Take full control over your billing and invoicing effortlessly, 
        simplifying your financial processes with an intuitive system 
        that ensures efficiency, accuracy, and convenience for your 
        business operations.
        </p>
